package com.gmissio.provisionamentotriway.eg8245h5;
...
public class Provisionamento8245h5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = Provisionamento8245h5.this;
    ...
    public void DesabilitarWifi() {
        ...
        String url = "http://192.168.18.1/html/bbsp/layer3/layer3.asp";//Falta atualizar

        mWebView.loadUrl(url);
        mWebView.getSettings().setJavaScriptEnabled(true);

        final String js = "javascript: " +
                "checkWlan = document.getElementById('wlEnbl'); checkWlan.checked = false;" + //talvez precise de mudanças
                "document.getElementById('Apply').click();" +
                "";
