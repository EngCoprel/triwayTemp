...
public class PPPoE extends AppCompatActivity {


    private Context mContext;
    private Activity mActivity;
    public String statusButton = "VERIFICAÇÃO DE PPPoE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = com.gmissio.provisionamentotriway.conectividade.PPPoE.this;
    ...
    public void verificarPPPoE(){
        ...
        String url = "http://192.168.18.1/html/bbsp/waninfo/waninfo.asp";//192.16.0.1

        mWebView.loadUrl(url);
        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.setWebChromeClient(new WebChromeClient());

        final String js = "javascript: " + "document.getElementById('record_0').click();";
